...
public class RequestActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private FirebaseRecyclerAdapter<Request, RequestViewHolder> mFirebaseAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<Request, RequestViewHolder>(
                Request.class,
            ...
            protected void populateViewHolder(final RequestViewHolder viewHolder,
                ...
                if (request.getAddress() == null) {
                    viewHolder.messengerImageView.setImageDrawable(ContextCompat.getDrawable(RequestActivity.this,
        ...
        addRequestButton = (FloatingActionButton) findViewById(R.id.addRequestButton);
        addRequestButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent addRequestIntent = new Intent(RequestActivity.this, AddRequestActivity.class);
                RequestActivity.this.startActivity(addRequestIntent);
            }
        });
    ...
    private void askForPermission(String permission, Integer requestCode) {
        if (ContextCompat.checkSelfPermission(RequestActivity.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(RequestActivity.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(RequestActivity.this, new String[]{permission}, requestCode);
